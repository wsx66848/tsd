...
train_cfg = dict(
    ...
    rcnn=dict(
        ...
        sampler=dict(
            type='RandomSampler',
            num=512,   # number of roi per image
            # num=1024,   # number of roi per image
            pos_fraction=0.25,
            neg_pos_ub=-1,
...
train_pipeline = [
    ...
    dict(type='Resize', img_scale=[(1333, 800), (1660, 1000)], keep_ratio=True),
...
lr_config = dict(
    ...
    warmup_iters=325, # 增长到该iter后, 就增到了baselr(在第一个epoch内)
...
work_dir = './work_dirs/backplane_voc_20200520_rcnn_r50_fpn_1x_multiscale_scorethr0.05_3'
load_from = None
resume_from = None
workflow = [('train', 1)]
